...
const features: Feature[] = [
  ...
  { name: 'GLOBAL DELIVERY', description: 'Ships to 200+ countries', icon: TruckIcon },
...
export const SiteFeatures: React.FC = () => {
    return (
      <section className="bg-blue-200 dark:bg-brand">
              ...
              <div key={index} className="flex items-start">
                <div className="flex-shrink-0">
                  <div className="flex h-12 w-12 items-center justify-center rounded-md bg-brand-100 dark:bg-brand-900">
                    <feature.icon className="h-8 w-8 text-highlight" aria-hidden="true" />
                  </div>
                </div>
                <div className="ml-4">
