...
export function CustomFooter({menu}: {menu?: EnhancedMenu}) {
    ...
    const itemsCount = menu
      ...
      return (
        ...
        >
          <div className={`container grid items-start grid-flow-row grid-cols-1 lg:grid-cols-${itemsCount} gap-2 lg:gap-6`}>
            {/* 新增: 社交媒体列 */}
           ...
           <div className="space-y-4 text-sm/6">
              <div>
                ...
                <a href="mailto:support@doonx.com" className="hover:text-contrast/80">
                  support@doonx.com
                </a>
              </div>
              <div>
                ...
                <p className="text-balance">
                  Longsheng Road, Longhua District,<br/>
              ...
              <div className="flex gap-x-6">
                {socialLinks.social.map((item) => (
                  <a key={item.name} href={item.href} className="hover:text-contrast/80">
            ...
            {/*<CountrySelector />*/}
            <div
              className={`self-end pt-8 opacity-50 col-span-1 lg:col-span-${itemsCount}`}
            >
